/**********************************************************************************************
 *   UnlimitedHand for Unity Plugin ver 0040α
 *   This code is used with an Arduino Code 
 *   "Serial_4Unity_4ProcessingQuaternion" in UH4Arduino0041.zip. or UH4Arduino0042.zip
 *   
 *   [Notification 1]
...
public class UH : MonoBehaviour {
	...
	void Update(){
		if(_serialPort  !=  null  &&  _serialPort.IsOpen) {
            ...
            //updateQuaternionPR();//you can use the objects "UHQuaternion[4]" and the UHPR[8].
            //updatePhotoSensors();
        }
	}
